    ...
    <div class="p-4">
      ...
      <nav class="space-y-1">
        <router-link
          ...
          :class="$route.path === '/Superadmin' ? 'text-blue-700 bg-blue-50' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'"
        >
        ...
        <router-link
          to="/Superadmin/users"
          class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors duration-150"
          :class="$route.path === '/Superadmin/users' ? 'text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'"
        >
        ...
        <router-link
          ...
          class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors duration-150"
          :class="$route.path === '/Superadmin/suppliers' ? 'text-green-700 bg-green-50' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'"
        >
