  ...
  methods: {
    ...
    async onSubmit() {
      ...
      try {
        ...
        const response = await axios.put(`/api/customers/${this.customer._id}`, payload, {
          headers: {
        ...
        this.error = error.response?.data?.message || 'An error occurred while updating the customer';
      } finally {
