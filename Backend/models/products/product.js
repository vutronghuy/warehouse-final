...
productSchema.pre("save", function (next) {
  ...
  if (this.basePrice !== undefined && this.priceMarkupPercent !== undefined) {
    this.finalPrice =
      this.basePrice + (this.basePrice * this.priceMarkupPercent) / 100;
  }
  next();
});
...
productSchema.pre(
  ...
  function (next) {
    ...
    if (
      ...
      updateData.priceMarkupPercent !== undefined
    ) {
      ...
      if (
        ...
        updateData.finalPrice =
          ...
          (updateData.basePrice * updateData.priceMarkupPercent) / 100;
      }
    }
